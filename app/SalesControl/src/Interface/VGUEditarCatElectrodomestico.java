...
/**/
public class VGUEditarCatElectrodomestico extends javax.swing.JFrame {

    public Controller controlador;
    public ApplianceCategory categoriaElectrodomestico;
    
    public VGUEditarCatElectrodomestico(Controller controlador, ApplianceCategory categoriaElectrodomestico){
    ...
    public void setLabels(){
        inptNombre.setText(this.categoriaElectrodomestico.getName());
        inptCaracteristicas.setText(this.categoriaElectrodomestico.getCharacteristics());
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (controlador.editarCategoriaElectrodomestico(nuevaCatElectrodomestico)){
            JOptionPane.showMessageDialog(this, "Categoría de electrodoméstico editada con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "No fue posible editar la categoría de electrodoméstico. Puede deberse a que pertenece a otro catálogo.", "Error", JOptionPane.ERROR_MESSAGE);
        }

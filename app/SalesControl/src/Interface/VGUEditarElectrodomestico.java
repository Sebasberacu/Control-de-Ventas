 ...
 *
 */
public class VGUEditarElectrodomestico extends javax.swing.JFrame {
    ...
    public Appliance electrodomestico;
    
    public VGUEditarElectrodomestico(Controller controlador, Appliance electrodomestico) {
    ...
    public void setLabel(){
        inptDescripcion.setText(this.electrodomestico.getDescription());
    }
    ...
    private void initComponents() {
        ...
        inptCategoria = new javax.swing.JComboBox<>(modelCategoria);
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        if (controlador.editarElectrodomestico(nuevoElectrodomestico)){
            JOptionPane.showMessageDialog(this, "Electrodoméstico editado con éxito.", "Éxito", JOptionPane.INFORMATION_MESSAGE);
        } else {
            JOptionPane.showMessageDialog(this, "No fue posible editar el electrodoméstico. Puede deberse a que pertenece a otro catálogo.", "Error", JOptionPane.ERROR_MESSAGE);
        }
